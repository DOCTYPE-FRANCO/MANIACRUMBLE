...
function HeroSection() {
    return (
        <div className="flex flex-col md:flex-row md:gap-[150px] gap-10 justify-center items-center mt-32 md:mt-2 w-full">
            <div className="flex flex-col justify-center gap-4  items-center hover:scale-105 transition-transform duration-500">
                <p className="text-2xl md:text-3xl text-center text-gray-500 font-bold md:max-w-[550px] ">
                    <Typewriter 
                        options={{
